...
const reasons = [
  { icon: ShieldCheck, title: "Надёжность", text: "Договор, страховка и проверенный транспорт на каждой экскурсии. Вы под защитой." },
  ...
  { icon: Award, title: "Опыт 5+ лет", text: "Более 10 000 туристов уже доверили нам свой отдых. Знаем каждый маршрут." },
